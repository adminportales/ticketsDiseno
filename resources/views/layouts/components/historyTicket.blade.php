<section class="border-0 row">
    <div class="col-md-8">
        <h6 class="text-center mb-3" style="text-transform: uppercase;">{{ $ticket->latestTicketInformation->title }}</h6>
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="info-tab" data-bs-toggle="tab" data-bs-target="#info"
                        type="button" role="tab" aria-controls="info" aria-selected="false">Entregas</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="all-tab" data-bs-toggle="tab" data-bs-target="#all"
                        type="button" role="tab" aria-controls="all" aria-selected="false">Historial</button>
                </li>
            </ul>
